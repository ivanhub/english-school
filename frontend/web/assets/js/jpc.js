...
//            priceTag: '<span class="price-tag-wrapper"> - <span class="price-tag"></span></span>',
            sidebar: {
                total: '<div class="total well"><h3>Всего: <span class="price"></span></h3></div>',
                summary: '<div class="summary well"><div class="itemized-summary"/></div>',
        ...
        setupPricesOverPeriod: function(){
            ...
            this.on('change', function(event){
                ...
                $.each(prices, function(index, value){
                    var text = self.formatPrice2(total * value.multiplier) + value.suffix;
...
/*        updatePriceTags: function(){
        ...
        renderItemizedSummary: function(summary){
            ...
            $.each(summary, function(index, value){
                ...
                var fragment = '<p><strong>' + title + ': </strong><br/>';
        ...
        formatPrice2: function(price){
            return this.options.signBefore + price.toFixed(0) + ' руб.';
        },
