...
<title>Matrik jawaban siswa</title>
<hr>
</head>
...
echo "<a href=\"eksportb01.php?kelas=$kelas&kode=$kode\"> ---- download format excel</a>";
}
echo "<table>";
echo "<tr><td colspan=6><center>Matrik jawaban siswa kelas <b>$kelas</b> $untuk $materi</td></tr>";

$query1=mysql_query("select * from siswa where kelas like '$kelas%' order by kelas, nama",$koneksi);
...
echo "<th>No</th>
   ...
   echo "</tr><tr><td colspan=5><center>K U N C I</td>";
   $knc=1;
...
echo "<tr><td colspan=5>B e n a r</td>";
$bnr=1;
