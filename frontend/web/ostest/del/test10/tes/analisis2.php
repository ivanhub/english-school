...
<table width=100%><th><Center><font color=#0F68A1><h2><b>Analisis Butir Soal</b></h2></font></center></th></table>
<hr>
</head>
...
echo "<tr><th rowspan=2>NO</th><th colspan=$spankolom><center>Efektifitas Distraktor <br><font size=1>(A=Kelompok Atas B=Kelompok Bawah)</th><th colspan=4><center>Tingkat Kesulitan</th><th colspan=4><center>Daya Pembeda</th></tr>";
...
while ($row=mysql_fetch_array($query))
{
	  ...
	  if ($abs=="1")
	  {
		echo "<tr><td rowspan=4>$no</td>";
	  	echo "<td colspan=$kolomgabung>$soal</td></tr>";
	  	echo "<tr><td colspan=$kolompilihan>a. $opsia</td>";
	  	echo "<td colspan=7>c. $opsic</td></tr>";
	  	echo "<tr><td colspan=$kolompilihan>b. $opsib</td>";
	  	if ($opsi>3)
	  	{
			echo "<td colspan=7>d. $opsid</td></tr>";
	  	}
	  	if ($opsi>4)
	  	{
			echo "<tr><td></td><td colspan=$kolomgabung>e. $opsie</td></tr>";
	  	}
          }
	  else
	  {
