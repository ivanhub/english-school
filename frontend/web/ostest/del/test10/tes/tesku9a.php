...
else
{
  ...
  echo "<table border=\"0\">";
          ...
          $jawab="jwb[$ary]";
	  $kunci=$row["kunci"];
          echo "<tr><td colspan=2><a href=tesku9b.php?file=$file&id=$ary&kunci=$kunci >| edit | </a>";
          echo "<a href=tesku10b.php?file=$file&id=$ary&pass=$password>| hapus | </a></td></tr>";
