...
include ("../koneksi.inc.php");
  ...
  {
      echo "<form method=\"post\" action=\"editbutirsoal4.php\">";
      $guru=$row["nama"];
      $materi=$row["materi"];
      ...
      echo "<tr>";
      echo "<td>Soal</td>";
      echo "<td><textarea name=\"soal\" cols=\"80\" rows=\"4\">$soal</textarea></td>";
      echo "</tr>";
      echo "<tr>";
      echo "<td>pilihan <b>a</b></td>";
      echo "<td><textarea name=\"opsia\" cols=\"80\" rows=\"1\">$opsia</textarea></td>";
      echo "</tr>";
      echo "<tr>";
      echo "<td>pilihan <b>b</b></td>";
      echo "<td><textarea name=\"opsib\" cols=\"80\" rows=\"1\">$opsib</textarea></td>";
      echo "</tr>";
      echo "<tr>";
      echo "<td>pilihan <b>c</b></td>";
      echo "<td><textarea name=\"opsic\" cols=\"80\" rows=\"1\">$opsic</textarea></td>";
      echo "</tr>";
      if ($row["opsi"]>3)
      {
          echo "<tr>";
          echo "<td>pilihan <b>d</b></td>";
          echo "<td><textarea name=\"opsid\" cols=\"80\" rows=\"1\">$opsid</textarea></td>";
          echo "</tr>";
          echo "<tr>";
      }
      if ($row["opsi"]>4)
      {
          ...
          echo "<td><textarea name=\"opsie\" cols=\"80\" rows=\"1\">$opsie</textarea></td>";
          echo "</tr>";
          echo "<tr>";
      }
