...
while ($row=mysql_fetch_array($query))
{
	  ...
	  echo "<tr><td>Kelas / Semester</td><td>$kelas</td><td> </td><td>-</td><tr>";
...
#	  echo "<tr><td width=5%>A</td><td width=5%>B</td><td width=5%>C</td><td width=5%>D</td><td width=5%>Omit</td></tr>";
