...
Китайский язык сегодня по праву занимает лидирующие позиции в мир е иностранных языков. С каждым годом всё большее количество людей переезжает в Китай жить, работать, учить язык. Стремительно развивающаяся китайская экономика позволит в ближайшее время говорить о китайском языке как о языке международного общения.
</p>
</div>
</div><br/><br/>
...
Почему выбирают нас при изучении китайского языка?</h5> <br/>
 ...
 <li style="font-size:115%;animation-duration: 1s; animation-delay: 1s;margin-top:25px">Интересная подача материала позволяет сделать занятия увлекательными и эффективными.</li>
 </li>
 </ul>
