...
/*$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Центр иностранных языков "Росакадемия". Обучение вождению по всем категориям: Обучение судовождению, вождению на квадроцикле, снегоходе, тракторе, погрузчике, гидроцикле, катере и т.д. Лучшая автошкола Самары. Звоните!',
]);
$this->registerMetaTag([
    'name' => 'keywords',
