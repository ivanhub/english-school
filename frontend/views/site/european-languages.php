...
Занятия по французскому языку проходят в небольших группах до 8 человек, что позволяет каждому слушателю принимать активное участие на каждом занятии. Группы формируются в зависимости от уровня знаний, возраста и времени занятий. На занятиях используется коммуникативная методика, которая позволяет слушателю самому регулировать процесс обучения.
</p>
</div>
</div><br/><br/>
<div class="linetire"></div>
...
<div class="col-sm-6 col-xs-12 col-sm-pull-6 text-left ">
<p class="mtext2 mtext2-chinese-right" style="clear:both; text-align:justify;line-height:1.1">
Вам необходимы знания немецкого языка для применения в профессиональной деятельности – для настоящих или будущих проектов? Или Вы хотите говорить на немецком языке без стеснения? Или Вы планируете переезд в Германию? На наших специальных курсах вы сможете быстро и эффективно развивать необходимые для Вашей цели знания языка.
</p>
</div>
</div>
